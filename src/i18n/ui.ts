...
export const ui = {
  pt: {
    ...
    'about.languagesValue': 'Português (nativo), Inglês (intermediário)',
    'about.skillsTitle': 'Habilidades técnicas',
    'about.education': 'Formação',
    'about.educationValue': 'Sistemas de Informação, UNIBALSAS - Faculdade de Balsas',
  ...
  en: {
    ...
    'about.languagesValue': 'Portuguese (native), English (intermediate)',
    'about.skillsTitle': 'Technical skills',
    'about.education': 'Education',
    'about.educationValue': 'BSc in Information Systems, UNIBALSAS - Faculdade de Balsas',
